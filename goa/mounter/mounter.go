...
// New constructs a mounter of the goa endpoints.
func New(opts ...Option) *Mounter {
	ret := &Mounter{
		...
		ErrorHandler: func(_ context.Context, _ http.ResponseWriter, err error) {
...
// EndpointModular represents the goa endpoint modular.
